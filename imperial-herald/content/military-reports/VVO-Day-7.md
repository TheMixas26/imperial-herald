...
summary = 'Седьмой день ВВО | Курда пал, Киберстан в огне и скавены в небе.'
+++
...
### 🧠 **Гениальная дерзость: операция "Жаль, что крысы не летают"**
...
Скавены в бронежилетах мчатся по разрушенным переходам,
а позади взрываются генераторы и гаснут голографические схемы.*

> *«Это не просто бой. Это апокалипсис на высоте тысячи трёхсот метров»*, 
> — передают с места.
