...
summary = 'Пятнадцатый день ВВО | Падение Котьха, мрак над Примоном и тень переговоров.'
+++
...
## **🌾 Осада Датана**
На юге развернута полноценная операция по блокаде **Датана** — стратегически важного аграрного центра. Его огромные фермы могут кормить до 30% войск Вераны. Подразделения Империи перерезали основные поставки и сейчас ведут точечные удары по линии укреплений.

Веранские инженеры пытались залить наступающих напалмом, но сработал антистихийный купол, разработанный в Аркане — первый полевой тест прошёл блестяще. Гвардия осталась нетронутой.
...
Предложение было передано через запертый внутри вражеской столицы (оставшийся в посольстве Империи) **501 Батальон Имперской Гвардии** и включает:
